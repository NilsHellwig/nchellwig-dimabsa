...
def get_prompt(text, subtask=3, language="eng", domain="restaurant"):
    ...
    prompts = {
        ...
        "jpn": {
            ...
            "scale": "1.00のスコアは非常にネガティブなvalenceまたは非常に低いarousalを示し、9.00は非常にポジティブなvalenceまたは非常に高いarousalを示し、5.00は中立のvalenceまたは中程度のarousalを表します。valence scoreとarousal scoreは両方とも正確に小数点以下2桁に四捨五入する必要があります。",
            "task_subtask3": "次のテキストについて、対応するアスペクト用語、アスペクトカテゴリ、意見用語、valence score、arousal scoreを含むすべての感情要素をタプルのリストの形式で認識してください [('aspect term', 'ENTITY#ATTRIBUTE', 'opinion term', 'valence score', 'arousal score'), ...]。",
            "task_subtask2": "次のテキストについて、対応するアスペクト用語、意見用語、valence score、arousal scoreを含むすべての感情要素をタプルのリストの形式で認識してください [('aspect term', 'opinion term', 'valence score', 'arousal score'), ...]。",
            "text_label": "テキスト:",
            "elements_label": "感情要素:"
        },
        "rus": {
            ...
            "scale": "Оценка 1.00 указывает на крайне негативный valence или очень низкий arousal, 9.00 указывает на крайне позитивный valence або очень высокий arousal, а 5.00 представляет собой нейтральный valence или средний arousal. И valence score, и arousal score должны быть округлены до ровно двух десятичных знаков.",
            "task_subtask3": "Для следующего текста распознайте все элементы настроения с соответствующими терминами аспектов, категориями аспектов, терминами мнений, valence score, arousal score в следующем тексте в виде списка кортежей [('aspect term', 'ENTITY#ATTRIBUTE', 'opinion term', 'valence score', 'arousal score'), ...].",
            "task_subtask2": "Для следующего текста распознайте все элементы настроения с соответствующими терминами аспектов, терминами мнений, valence score, arousal score в следующем тексте в виде списка кортежей [('aspect term', 'opinion term', 'valence score', 'arousal score'), ...].",
            "text_label": "Текст:",
        ...
        "tat": {
            ...
            "scale": "1.00 балл бик тискәре valence яки бик түбән arousal күрсәтә, 9.00 бик уңай valence яки бик югары arousal күрсәтә, ә 5.00 нейтраль valence яки уртача arousal белдерә. valence score һәм arousal score икесе дә төгәл ике утырмалы саннарга түгәрәкләнергә тиеш.",
            "task_subtask3": "Түбәндәге текст өчен барлык хис-кичерешләр элементларын тиешле аспект терминнары, аспект категорияләре, фикер терминнары, valence score, arousal score белән кортежлар исемлеге рәвешендә тану [('aspect term', 'ENTITY#ATTRIBUTE', 'opinion term', 'valence score', 'arousal score'), ...].",
            "task_subtask2": "Түбәндәге текст өчен барлык хис-кичерешләр элементларын тиешле аспект терминнары, фикер терминнары, valence score, arousal score белән кортежлар исемлеге рәвешендә тану [('aspect term', 'opinion term', 'valence score', 'arousal score'), ...].",
            "text_label": "Текст:",
        ...
        "ukr": {
            ...
            "scale": "Оцінка 1.00 вказує на надзвичайно негативний valence або дуже низький arousal, 9.00 вказує на надзвичайно позитивний valence або дуже високий arousal, а 5.00 представляє нейтральний valence або середній arousal. І valence score, і arousal score повинні бути округлені до рівно двох десяткових знаків.",
            "task_subtask3": "Для наступного тексту розпізнайте всі елементи настрою з відповідними термінами аспектів, категоріями аспектів, термінами думок, valence score, arousal score у наступному тексті у вигляді списку кортежів [('aspect term', 'ENTITY#ATTRIBUTE', 'opinion term', 'valence score', 'arousal score'), ...].",
            "task_subtask2": "Для наступного тексту розпізнайте всі елементи настрою з відповідними термінами аспектів, термінами думок, valence score, arousal score у наступному тексті у вигляді списку кортежів [('aspect term', 'opinion term', 'valence score', 'arousal score'), ...].",
            "text_label": "Текст:",
        ...
        "zho": {
            ...
            "scale": "1.00的分数表示极度负面的valence或非常低的arousal，9.00表示极度正面的valence或非常高的arousal，5.00表示中性的valence或中等的arousal。valence score和arousal score都必须精确地四舍五入到两位小数。",
            "task_subtask3": "对于以下文本，识别具有相应方面术语、方面类别、意见术语、valence score、arousal score的所有情感元素，以元组列表的形式 [('aspect term', 'ENTITY#ATTRIBUTE', 'opinion term', 'valence score', 'arousal score'), ...]。",
            "task_subtask2": "对于以下文本，识别具有相应方面术语、意见术语、valence score、arousal score的所有情感元素，以元组列表的形式 [('aspect term', 'opinion term', 'valence score', 'arousal score'), ...]。",
            "text_label": "文本：",
            "elements_label": "情感元素："
        }
    }
