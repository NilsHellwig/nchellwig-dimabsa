...
def get_prompt(text, subtask=3, language="eng", domain="restaurant"):
    ...
    prompts = {
        "eng": {
            ...
            "opinion_term": "The 'opinion term' is the exact word or phrase in the text that refers to the sentiment or attitude expressed by a user towards a particular aspect or feature of a product or service.",
            ...
            "task_subtask3": "For the following text, recognize all sentiment elements with their corresponding aspect terms, aspect categorys, valence, arousal, opinion terms in the following text in the form of a list of tuples [('aspect term', 'aspect category', 'opinion term', 'valence', 'arousal'), ...].",
            "task_subtask2": "For the following text, recognize all sentiment elements with their corresponding aspect terms, valence, arousal, opinion terms in the following text in the form of a list of tuples [('aspect term', 'opinion term', 'valence', 'arousal'), ...].",
            "text_label": "Text:",
        ...
        "jpn": {
            ...
            "opinion_term": "「意見用語」は、製品やサービスの特定の側面や特徴に対してユーザーが表現する感情や態度を指すテキスト内の正確な単語またはフレーズです。",
            ...
            "task_subtask3": "次のテキストについて、対応するアスペクト用語、アスペクトカテゴリ、意見用語、valence、arousalを含むすべての感情要素をタプルのリストの形式で認識してください [('aspect term', 'aspect category', 'opinion term', 'valence', 'arousal'), ...]。",
            "task_subtask2": "次のテキストについて、対応するアスペクト用語、意見用語、valence、arousalを含むすべての感情要素をタプルのリストの形式で認識してください [('aspect term', 'opinion term', 'valence', 'arousal'), ...]。",
            "text_label": "テキスト:",
            "elements_label": "感情要素:"
        },
        "rus": {
            ...
            "opinion_term": "«Термин мнения» - это точное слово или фраза в тексте, которое относится к настроению или отношению, выраженному пользователем к определенному аспекту или особенности продукта или услуги.",
            "valence": "«valence» измеряет степень позитивности или негативности.",
            "arousal": "«arousal» измеряет интенсивность эмоции.",
            "scale": "Оценка 1.00 указывает на крайне негативный valence или очень низкий arousal, 9.00 указывает на крайне позитивный valence или очень высокий arousal, а 5.00 представляет собой нейтральный valence или средний arousal.",
            "task_subtask3": "Для следующего текста распознайте все элементы настроения с соответствующими терминами аспектов, категориями аспектов, терминами мнений, valence, arousal в следующем тексте в виде списка кортежей [('aspect term', 'aspect category', 'opinion term', 'valence', 'arousal'), ...].",
            "task_subtask2": "Для следующего текста распознайте все элементы настроения с соответствующими терминами аспектов, терминами мнений, valence, arousal в следующем тексте в виде списка кортежей [('aspect term', 'opinion term', 'valence', 'arousal'), ...].",
            "text_label": "Текст:",
        ...
        "tat": {
            ...
            "opinion_term": "«Фикер термины» - текстта кулланучының продукт яки хезмәтнең билгеле бер аспекты яки үзенчәлеге турында белдергән хисләренә яки мөнәсәбәтенә мөрәҗәгать итүче төгәл сүз яки фраза.",
            ...
            "task_subtask3": "Түбәндәге текст өчен барлык хис-кичерешләр элементларын тиешле аспект терминнары, аспект категорияләре, фикер терминнары, valence, arousal белән кортежлар исемлеге рәвешендә тану [('aspect term', 'aspect category', 'opinion term', 'valence', 'arousal'), ...].",
            "task_subtask2": "Түбәндәге текст өчен барлык хис-кичерешләр элементларын тиешле аспект терминнары, фикер терминнары, valence, arousal белән кортежлар исемлеге рәвешендә тану [('aspect term', 'opinion term', 'valence', 'arousal'), ...].",
            "text_label": "Текст:",
        ...
        "ukr": {
            ...
            "opinion_term": "«Термін думки» - це точне слово або фраза в тексті, яке відноситься до настрою або ставлення, висловленого користувачем до певного аспекту або особливості продукту чи послуги.",
            ...
            "task_subtask3": "Для наступного тексту розпізнайте всі елементи настрою з відповідними термінами аспектів, категоріями аспектів, термінами думок, valence, arousal у наступному тексті у вигляді списку кортежів [('aspect term', 'aspect category', 'opinion term', 'valence', 'arousal'), ...].",
            "task_subtask2": "Для наступного тексту розпізнайте всі елементи настрою з відповідними термінами аспектів, термінами думок, valence, arousal у наступному тексті у вигляді списку кортежів [('aspect term', 'opinion term', 'valence', 'arousal'), ...].",
            "text_label": "Текст:",
        ...
        "zho": {
            ...
            "opinion_term": "'意见术语'是文本中指用户对产品或服务的特定方面或特征所表达的情感或态度的确切单词或短语。",
            ...
            "task_subtask3": "对于以下文本，识别具有相应方面术语、方面类别、意见术语、valence、arousal的所有情感元素，以元组列表的形式 [('aspect term', 'aspect category', 'opinion term', 'valence', 'arousal'), ...]。",
            "task_subtask2": "对于以下文本，识别具有相应方面术语、意见术语、valence、arousal的所有情感元素，以元组列表的形式 [('aspect term', 'opinion term', 'valence', 'arousal'), ...]。",
            "text_label": "文本：",
            "elements_label": "情感元素："
        }
    }
